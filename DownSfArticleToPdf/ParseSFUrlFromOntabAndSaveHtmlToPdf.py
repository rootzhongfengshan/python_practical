...
#originalurl='https://www.one-tab.com/page/aGvuKi9WQ5Cqxt44G4OI5A'
def returnurlfromhtml(originalurl):
    ...
    return outputurl
#originalurl='https://segmentfault.com/a/1190000006084106'
def returnhtmlarticle(originalurl):
    ...
    savetitlename = str(title[0])
    if savetitlename :
        savetitlename = re.sub('[\n\\\\/:*?\ "<>|]', '', savetitlename)
    else :
        savetitlename = "Error";
    articleall=str(soup.find_all('div'))
    artstdtxt=soup.find_all('div',class_='article fmt article__content')
    ...
    if artstdtxt:
        ...
        artbody = re.sub('data-src="','src="https://segmentfault.com',article)
    else:
...
if __name__ == "__main__":
    ...
    urls = ['https://www.one-tab.com/page/2YYVP-lhTQyS4iIdBpkwkg'
            ]
    result=[]
    errresult=[]
    for url in urls:
        ...
        for dealurl in outputurls: 
            ...
            dirpath = pwd + '/SFDownloadArticle'+date+'/'
