...
if __name__ == "__main__":
    ...
    urls = ['https://mp.weixin.qq.com/s?__biz=MzIwNDY3MDg1OA==&mid=2247484425&idx=1&sn=47cb5d0eac4ee3bbd8ebb79f224c6fcf&chksm=973dd6eca04a5ffa8187d1645791bac898fe171a63266c17b0269592f457a9a3ff6b160951e5&scene=21#wechat_redirect'
            ]
    result=[]
    errresult=[]
    for url in urls:
        ...
        print(url)
        savetitlename,artbody=returnhtmlarticle(url)
